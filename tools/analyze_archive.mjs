...
const ARCHIVE_URL = 'https://m3db.com/archive/lyrics/year/2026';
...
try {
  ...
  writeFileSync('debug/archive.html', html, 'utf8');
  console.log('✅ HTML saved to debug/archive.html\n');
  ...
  console.log('--- First 30 lyric links ---\n');
